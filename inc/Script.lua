...
return '👨🏾‍🔧¦ اصدار سورس الباشا : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/BASSHAV1/Tools/master/GetVersion.txt') or 0
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الباشا يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="ســورس : الباشا 🍃",url="t.me/ooo9z"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الباشا](t.me/ooo9z)',nil,inline,msg.id_)
return false
end
