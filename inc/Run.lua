...
basha = Token:match("(%d+)")
redis:mset(
basha..":VERSION",GetUser.information.Source_version,
basha..":SUDO_ID:",GetUser.information.id,
basha..":DataCenter:",GetUser.information.DataCenter,
basha..":UserNameBot:",BOT_User,
basha..":NameBot:",BOT_NAME,
"TH3BOSS_INSTALL","Yes"
)
redis:hset(basha..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
info = {}
info.username = '@'..GetUser.information.username
info.userbot  = BOT_User
info.userjoin  = io.popen("whoami"):read('*a'):gsub('[\n\r]+', '') 
https.request(GetUser.information.WebSite..'/v1/request/?insert='..JSON.encode(info))
Cr_file = io.open("./inc/Token.txt", "w")
Cr_file:write(Token)
Cr_file:close()
print('\27[1;36m￤Token.txt is created.\27[m')
local Text = "🙋🏼‍♂️¦ اهلا عزيزي [المطور الاساسي](tg://user?id="..GetUser.information.id..") \n🔖¦ شكرا لاستخدامك سورس الباشا \n📡¦ أرســل  الان /start\n📛¦ لاضهار الاوامر للمطور  المجهزه بالكيبورد\n\n⚡️"
...
print('\27[0;33m>>'..Kenawlogo..'\027[0;32m')
create_config()
else
...
Bot_User = redis:get(basha..":UserNameBot:")
SUDO_ID = tonumber(redis:get(basha..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(basha..'username:'..SUDO_ID).username
version = redis:get(basha..":VERSION")
DataCenter = redis:get(basha..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..basha..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(basha..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if msg.type ~= "pv" and redis:get(basha..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
...
if redis:get(basha..'group:add'..msg.chat_id_) then 
...
if msg.GroupActive and redis:get(basha..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end
...
msg.Rank = 1
elseif redis:sismember(basha..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور 👨🏽‍💻'
msg.TheRank = 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(basha..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء 👷🏽'
msg.TheRank = 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(basha..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير 👨🏼‍⚕️' 
msg.TheRank = 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(basha..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن 👨🏼‍🎓'
msg.TheRank = 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(basha..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(basha..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(basha..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(basha..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(basha..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(basha..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(basha..':NameBot:')..[[ 🎖
...
if msg.content_.ID == "MessageChatJoinByLink" and redis:get(basha..':lock_Add_User:'..msg.chat_id_) then 
...
if msg.Admin then redis:srem(basha..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(basha..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.text and not msg.forward_info_ and ScriptFile.iBoss then
...
print("user is flood")
redis:setex(basha..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',10,true)
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Error" then
StatusLeft(arg.chat_id_,our_id)
local NameGroup = Flter_Markdown(redis:get(basha..'group:name'..arg.chat_id_) or "")
...
if GetMsg then
print("\27[1;35m¦This_Msg : ",basha.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
redis:setex(basha..'sender:'..data.id_..':'..arg.chat_id_..'flood',300,true)
...
redis:del(basha..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,
basha..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':photo:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':voice:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':audio:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':animation:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':edited:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':video:'..msg.chat_id_..':'..msg.sender_user_id_,
basha..':Flood_Spam:'..msg.sender_user_id_..':'..msg.chat_id_..':msgs')
return false 
end
...
if GetMsg then
print("\27[1;35m¦This_Msg : ",basha.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
function tdcli_update_callback(data)
	...
	redis:srem(basha..'users',msg.sender_user_id_)
	end
	...
	download_file('https://raw.githubusercontent.com/BASSHAV1/BASHA/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/BASSHAV1/BASHA/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/BASSHAV1/BASHA/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/BASSHAV1/BASHA/master/inc/functions.lua','./inc/functions.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(basha..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح')
	dofile("./inc/Run.lua")
	...
	if redis:get(basha..'group:add'..data.chat_.id_) then
	redis:set(basha..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	elseif data.ID == "UpdateChannel" then  
	if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
	if redis:get(basha..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(basha..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = Flter_Markdown(redis:get(basha..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	basha..'group:name'..k,IDS.Title,
	basha..'num_msg_max'..k,5,
	basha..'group:add'..k,true,
	basha..'lock_link'..k,true,
	basha..'lock_spam'..k,true,
	basha..'lock_webpage'..k,true,
	basha..'lock_markdown'..k,true,
	basha..'lock_flood'..k,true,
	basha..'lock_bots'..k,true,
	basha..'mute_forward'..k,true,
	basha..'mute_contact'..k,true,
	basha..'mute_document'..k,true,
	basha..'mute_inline'..k,true,
	basha..'lock_username'..k,true,
	basha..'replay'..k,true
	)
	redis:sadd(basha..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(basha..'username:'..ID,'username',user)
	redis:sadd(basha..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(basha..'username:'..ID,'username',user)
	redis:sadd(basha..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(basha..'username:'..ID,'username',user)
	redis:sadd(basha..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(basha..'group:ids')..'* 🌿\n✓')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(basha..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(basha..'username:'..data.user_.id_).username
	...
	redis:hset(basha..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
